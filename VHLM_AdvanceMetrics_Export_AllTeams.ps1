...
$statsFileName = "VHLMS68AdvanceMetrics.csv"
...
$baseurl = "https://vhlportal.com/VHLM/68/VHLM68-$GameNumber.html"
...
$rawteamname = $gamepage.AllElements | Where Class -eq "STHSGame_PlayerStatTitle" | Select -ExpandProperty innerText
$tempteamname = $rawteamname -split "for "
$VisitorTeamName = $tempteamname[1]
$HomeTeamName = $tempteamname[3]
